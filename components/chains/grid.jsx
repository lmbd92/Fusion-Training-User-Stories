...
const GridChain = (props) => {
  const {
    children,
    customFields: { desktopCols = "4", tabletCols = "6", mobileCols = "12" },
    id,
  } = props;
...
GridChain.propTypes = {
  customFields: PropTypes.shape({
    desktopCols: PropTypes.oneOf(["12", "6", "4", "3"]).tag({
      labels: {
        12: "1",
        6: "2",
        4: "3",
    ...
    tabletCols: PropTypes.oneOf(["12", "6", "4", "3"]).tag({
      labels: {
        12: "1",
        6: "2",
        4: "3",
    ...
    mobileCols: PropTypes.oneOf(["12", "6", "4"]).tag({
      labels: {
        12: "1",
        6: "2",
        4: "3",
